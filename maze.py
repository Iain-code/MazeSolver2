...
class Maze:
    ...
    def _solve_r(self, i, j):
        ...
        if i + 1 < self.num_cols and self._cells[i][j].has_right_wall == False and self._cells[i + 1][j].visited == False:
        ...
        if j + 1 < self.num_rows and self._cells[i][j].has_bottom_wall == False and self._cells[i][j + 1].visited == False:
